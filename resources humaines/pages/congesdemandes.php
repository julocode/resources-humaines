  ...
  <div class="container">
    ...
    <div class="panel-body">
        ...
        <tbody>
            ...
            <td>
            <a href="accepterconge.php?idemp=<?php echo $congesdemandes['idemp']?>"> <span class="material-icons">done</span></a>
            <a href="refuserconge.php?idemp=<?php echo $congesdemandes['idemp']?>"> <span class="material-icons">close</span></a> 
            </td>
            </tr>
            <?php } ?>
            </tbody>
