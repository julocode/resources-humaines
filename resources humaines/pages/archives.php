<?php
  ...
  $nomE=isset($_GET['nomE'])?$_GET['nomE']:"";
  $requete="select *from employesarchiver where nom like '%$nomE%' limit $size offset $offset";
...
<meta name="theme-color" content="#7952b3">
  ...
  <div class="container">
   ...
   <div  class="panel-heading" style=" display: inline-block;width: 500px;height: 100px;color:white;font-size:xx-large;">> Liste des employés archivés</div>
    ...
    <form method="get" action="modifieremployesarchives.php">
    <div class="panel-body">
        ...
        <tbody>
            ...
            <td><?php echo $employesarchiver['poste'] ?></td>
            <td><?php echo $employesarchiver['email'] ?></td>
            <td><?php echo $employesarchiver['telephone'] ?></td>
            <td>
            <a href="modifieremployesarchives.php?idemp=<?php echo $employesarchiver['idemp']; ?>" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
            <a onclick="return confirm('Etes vous sûr de vouloir supprimer l\'employé')" href="supprimeremployesarchives.php?idemp=<?php echo $employesarchiver['idemp']; ?>" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a></td>
            </tr>
            <?php } ?>
            </tbody>
        </table>
